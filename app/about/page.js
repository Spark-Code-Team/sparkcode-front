...
const About = () => {
  const missionVision = [
    {
      title: "ماموریت ما",
      desc: "تاکید بر ارائه راه‌حل‌های نوآورانه و با کیفیت در زمینه طراحی وب و برنامه‌نویسی برای رشد و موفقیت مشتریان.",
    },
    {
      title: "چشم‌انداز ما",
      desc: "هدف ما تبدیل شدن به یکی از برترین شرکت‌های فناوری در منطقه با ارائه خدمات مبتنی بر نوآوری و رضایت‌مندی مشتریان است.",
    },
  ];
