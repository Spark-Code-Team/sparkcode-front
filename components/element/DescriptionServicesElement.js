    ...
    return (
        ...
        <>
            ...
            <div className="w-full text-center md:text-right px-8 lg:mt-20 mt-10">
                ...
                <div className={`lg:w-[85%] bg-slate-800 p-5 rounded-xl mb-10 w-full m-auto lg:mt-14 flex flex-col lg:flex-row `}>
                ...
                <div className={`lg:w-[85%] bg-slate-800 p-5 rounded-xl mb-10 w-full m-auto lg:mt-14 flex flex-col lg:flex-row-reverse`}>
                <div className="lg:w-1/2 m-auto mb-4 lg:flex lg:justify-center">
