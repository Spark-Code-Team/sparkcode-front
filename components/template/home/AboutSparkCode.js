    ...
    return(
        ...
        <>
            ...
            <div className="w-full lg:mt-24 mt-10">
                ...
                <div className="lg:w-[85%] w-full flex m-auto mt-14">

                    <div className="lg:w-1/2 flex flex-wrap items-center text-base lg:pr-7 lg:pl-14">
                        ...
                        <Link href="#" className="bg-[#2e567d] lg:w-[135px] lg:h-[51px] gap-x-1 flex justify-center items-center lg:mt-6 text-white rounded-lg">
                            درباره ما <ArrowRight/>
                        </Link>

                    </div>

                    <div className="lg:w-1/2 flex justify-center lg:pr-10 lg:pl-10">
