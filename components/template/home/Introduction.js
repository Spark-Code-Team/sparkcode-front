    ...
    return(
        ...
        <>
            ...
            <div className="lg:w-full lg:h-[750px] lg:pt-1 lg:mt-0 custom-background">
                ...
                <div className="w-full text-sm leading-7 text-white -mt-7 lg:hidden pr-3 pl-3 lg:hidden block">ما به ارتباط نزدیک با مشتریان خود اعتقاد داریم. تیم ما با دقت به نیازها و خواسته‌های شما گوش می‌دهد و در طی فرآیند توسعه، با شفافیت و صداقت با شما در ارتباط است. این همکاری نزدیک به ما کمک می‌کند.</div>
